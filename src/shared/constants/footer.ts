...
export const FOOTER_SECTIONS = [
  {
    ...
    links: [
      { label: "Çiçek Bakımı", href: "#" },
      { label: "Çiçek Eşliğinde Notlar", href: "#" },
      { label: "Çiçek Anlamları", href: "#" },
      { label: "Özel Günler", href: "#" },
      { label: "Mevsimlere Göre Çiçekler", href: "#" },
      { label: "BonnyFood Saklama Koşulları", href: "#" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Kariyer", href: "#" },
      { label: "Çiçek Sepeti'nde Satış Yap", href: "#" },
      { label: "Kurumsal Müşterilerimiz", href: "#" },
      { label: "Reklamlarımız", href: "#" },
...
export const FOOTER_TEXTS = {
  ...
  copyright: "Copyright © 2025 ÇiçekSepeti.com. Tüm hakları saklıdır.",
} as const;
